...
export default function MyStory() {
  return (
    <Container id="myStory">
      ...
      <div class="description project text-center p-5">
        My transition into the full-stack development career first started in
        ...
        education sector. Many teachers were forced to utilize websites and
        ...
        earned a PMP through Google's Coursera and a certificate from ISTE in AI
        explorations and Their Practical Use in School Environments.
      </div>
    </Container>
  );
}
